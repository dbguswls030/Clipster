...
public struct URLMetaData{
    ...
    public init(title: String? = nil, description: String? = nil, thumbnailImageURL: URL? = nil) {
        self.title = title
    ...
    static public var sampleData: URLMetaData{
        return URLMetaData(
            ...
            thumbnailImageURL: URL(string: "https://img1.daumcdn.net/thumb/R800x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2Fypn5C%2FbtsGY8CFdMb%2FSBVknuOs4TmrocmmyGyms1%2Ftfile.svg")!
        )
    }
}
